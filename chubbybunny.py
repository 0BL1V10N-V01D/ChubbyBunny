...
def printBanner():
    ...
    print(GREEN + BOLD + '      ,/_| ' + END + BOLD + '0' + GREEN + BOLD + '| _ | ' + END + BOLD + '0' + GREEN + BOLD + '|_\,    ' + END + BOLD + '[' + GREEN + BOLD + '--' + END + BOLD + ']' + VIOLET + BOLD + '             Version:' + RED + ' 1.1.0' + END + BOLD + '              [' + GREEN + BOLD + '--' + END + BOLD + ']')
